...
All notable changes to the Icelandic Law MCP Server will be documented in this file.
...
## [1.0.1] - 2026-02-15 - Free Tier Finalization

### Added
- Finalized free-tier ingestion snapshot from official Althingi Lagasafn.
- Documented latest verified corpus and validation gate results in `README.md`.
- Added current source snapshot details to `DATA_SOURCES.md`.
- Added explicit free dataset scope notes to `LEGAL_DATA_LICENSE.md`.

### Changed
- Free-tier ingestion output now reports duplicate law IDs merged deterministically.
- Database build/runtime compatibility was hardened for SQLite artifact handling.

### Data Snapshot
- Source files scanned: `1724`
- Parsed laws: `1714`
- Written statute seed files: `1709`
- Duplicate law IDs merged: `5`
- Built free DB:
