...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (lögmannssamningur)
...
If you are a lawyer (lögmaður), legal researcher, or other legal professional:

- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (starfsábyrgð)
...
- **Professional Rules**: Members of the Icelandic Bar Association (Lögmannafélag Íslands) must comply with applicable professional conduct rules (siðareglur lögmanna) when using AI tools
...
1. Checking the official source (Alþingi — althingi.is, or government.is/legislation)
2. Verifying the provision is currently in force (í gildi) and has not been amended (breytt)
3. Reading the full context of cited provisions
4. Consulting case law (dómaframkvæmd) and explanatory materials (greinargerð) for interpretation
...
This Tool aggregates data from official Icelandic legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **althingi.is (Alþingi)** | Authoritative | Statute text, parliamentary acts (primary reference) |
| **government.is/legislation** | Authoritative | Consolidated legislation, regulations (reglugerðir) |
| **Community/open-data sources** | Supplementary | Cross-references, metadata (verify independently) |
| **EFTA / EEA databases** | Authoritative for EEA law | EEA Agreement, EU-derived legislation |
...
- Icelandic law changes continuously through new statutes (lög), amendments (breytingarlög), and court decisions (dómar)
...
- Even "fresh" data may be outdated if recent amendments were published in Stjórnartíðindi (the official gazette)
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (gildandi lög og reglur)

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended (breytt) after the last database update
  - Repealed (felld úr gildi) but not yet removed from the database
  - Subject to transitional rules (bráðabirgðaákvæði) affecting its applicability
...
1. **Complete case law** -- Coverage of the Supreme Court (Hæstiréttur), Court of Appeals (Landsréttur), and lower court decisions is limited
2. **Historical statute versions** -- Limited availability of historical provision wording (söguleg lagaákvæði)
3. **Legal commentary** -- No editorial annotations, academic commentary (fræðileg umfjöllun), or practice guides
4. **Unpublished decisions** -- Administrative rulings largely absent
5. **Full legislative history** -- Limited coverage of parliamentary materials (þingskjöl, greinargerðir)
...
- **EEA Law Blind Spots**: Cannot fully assess EEA Agreement obligations or EU-derived legislation incorporated into Icelandic law
...
- This includes but is not limited to:
  - Professional malpractice claims (skaðabótakröfur vegna starfsábyrgðar)
  - Lost cases or adverse judgments
  - Client harm from erroneous advice
  - Regulatory sanctions from bar authorities (agaviðurlög)
  - Reputational damage
...
## EEA and EU AI Act Compliance

This Tool is a **general-purpose AI system**. The EU AI Act applies in Iceland as an EEA contracting party. It is NOT a high-risk "administration of justice" system (which applies to AI used by courts and prosecutors for case outcomes).
...
- **Sensitive Matters**: For privileged legal matters (trúnaðarskylda lögmanns), consider on-premise deployment

### Competence and Diligence

Using this Tool does not reduce your professional obligations to:

- Exercise independent legal judgment (sjálfstæð lagaleg úttekt)
- Conduct thorough legal research using authoritative sources
- Stay current with legal developments
- Provide competent representation (vandvirkni í lögmannsstarfi)

## Recommended Workflow for Professional Use

1. **Initial Research**: Use Tool for preliminary research and hypothesis generation
2. **Official Verification**: Cross-check ALL results with official sources (althingi.is, government.is/legislation)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Icelandic-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Icelandic-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (althingi.is, government.is/legislation)
...
- **COMPLY** with Lögmannafélag Íslands professional ethics rules regarding AI tool use and client confidentiality
- **DISCLOSE** to clients if required by professional rules (siðareglur lögmanna)
