/**
 * get_eu_basis — Retrieve EU legal basis for an Icelandic statute.
 */
...
/**
 * Get EU legal basis for an Icelandic statute.
 *
...
export async function getEUBasis(
  ...
  `).get(lawNumber) as { id: string; title: string } | undefined;
