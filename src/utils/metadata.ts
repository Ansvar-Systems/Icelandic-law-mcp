...
export interface ResponseMetadata {
  ...
  /** Optional note (e.g., when document_id resolution fails) */
  note?: string;

  /** Query strategy indicator (e.g., 'broadened', 'like_fallback') */
...
function getSourceAuthority(): SourceAuthority {
  return {
    primary_source: 'Althingi Lagasafn (official Icelandic Parliament publication) and related Althingi official channels',
    authority_level: 'official',
    verification_required: 'ALWAYS cross-check with official Althingi publications and Stjornartidindi before relying on results in professional legal work.'
  };
}
